...
public class PolicyNegotiationDistanceNAV {
    ...
    public static void main(String[] args) {
        ...
        double[] distances={0.4};

        for(int ndist=0;ndist<maxdistances;ndist++){
            double minDistance=distances[ndist];
            PrintStream resfile=null;
            try{
                resfile = new PrintStream("../result-1000rep-heuristic-NAV-d"+distances[ndist]*10+"-RT"+NumberOfRelTypes);
        ...
        try{
            detailedLog = new PrintStream("../detailedLog-NAV-"+nagents);
        } catch(FileNotFoundException e){
        }
