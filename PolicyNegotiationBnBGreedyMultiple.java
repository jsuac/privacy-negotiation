...
public class PolicyNegotiationBnBGreedyMultiple {
    ...
    public static void main(String[] args) {
        ...
        for(int ndist=0;ndist<maxdistances;ndist++){
            ...
            try{
                resfile = new PrintStream("../result-1000rep-BnBGreedy-AG3-RT"+NumberOfRelTypes);
        ...
        try{
            detailedLog = new PrintStream("../detailedLog-BNBGreedy-AG3-"+nagents);
        } catch(FileNotFoundException e){
        }
    ...
    do{
        ...
        for(int j=0;j<nagents;j++){
            if(auxVector[j]==-1){
                ...
                auxUT= Util.greedySolution(auxVector, auxSolution, auxNumberTried, nagents, a1, a2, a3); 
