...
public class PolicyNegotiationGreedy {
    ...
    public static void main(String[] args) {
        ...
        for(int ndist=0;ndist<maxdistances;ndist++){
            ...
            try{
                resfile = new PrintStream("../result-1000rep-greedy-except2-RT"+NumberOfRelTypes);
        ...
        try{
            detailedLog = new PrintStream("../detailedLog-greedy-except2-"+nagents);
        } catch(FileNotFoundException e){
        }
