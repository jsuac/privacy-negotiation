...
public class PolicyNegotiationDistance {
    ...
    public static void main(String[] args) {
        ...
        double[] distances={0.3};

        for(int ndist=0;ndist<maxdistances;ndist++){
            double minDistance=distances[ndist];
            PrintStream resfile=null;
            try{
                resfile = new PrintStream("../result-100rep-heuristic-d"+distances[ndist]*10+"-RT"+NumberOfRelTypes);
        ...
        for(int nagents=50;nagents<70;nagents=nagents+10)
        {
        ...
        try{
            detailedLog = new PrintStream("../detailedLog-d"+distances[ndist]*10+"-"+nagents);
        } catch(FileNotFoundException e){
        }
