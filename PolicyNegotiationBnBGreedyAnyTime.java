...
public class PolicyNegotiationBnBGreedyAnyTime {
    ...
    public static void main(String[] args) {
        ...
        long t1=0,t2=0,tot=0;

        for(int ndist=0;ndist<maxdistances;ndist++){
            
            PrintStream resfile=null;
            try{
                resfile = new PrintStream("../result-1000rep-BnBGreedy-TIME-50ms-RT"+NumberOfRelTypes);
        ...
        for(int nagents=190;nagents<210;nagents=nagents+10)
        {
